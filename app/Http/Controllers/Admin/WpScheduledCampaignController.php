    ...
    public function store(Request $request)
    {
        ...
        try {
            $campaignId = DB::transaction(function () use (
                ...
                $dateRows, $isMultiple, $method, $reservationService, &$substitutionCount
            ) {
            ...
            return back()->with('cus__error', 'Could not create WordPress scheduled campaign: '.$e->getMessage())->withInput();
        }
        ...
        $successMessage = 'WordPress scheduled campaign created. Posts will be sent to WordPress with their schedule dates.';
