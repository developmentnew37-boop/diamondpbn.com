...
import { initSelectManager } from "./helper/selectBox";
//export
 function allowOnlyNumbers(numInp) {
    if (numInp.length) {
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    if (step__04) {
        ...
        //     let selectedDomainMethod = document.querySelector('input[name="sel_domains"]:checked').value;

        //     let campaign_domain_holder = document.getElementById('campaigns_domains_holder');

        //     if (selectedDomainMethod == '0') {

        //         campaign_domain_holder.value = localStorage.getItem('selectDomains')

        //     } else if (selectedDomainMethod == '1') {

        //         campaign_domain_holder.value = localStorage.getItem('selectSetDomains')

        //     } else {
        //         // validate domains | /api/admin/domains/validate
        //         console.log("maunual-domains", manualDomainsArea.value);

        //         let domains = manualDomainsArea.value.split("\n")
        //             .filter((line) => line.trim() !== "");

        //         if (domains.length != postCount) {
        //             alert("manual domains should equal to postCount");
        //             return;
        //         }

        //         let icon = step__04.querySelector('.check-icon');
        //         let loader = step__04.querySelector('.loader');
        ...
        //             let url = '/api/admin/domains/validate';
        ...
        //             if (res.status) {
        //                 alert(`${res.message}`);
        //                 campaign_domain_holder.value = JSON.stringify(res.data.domain_ids);
        //                 console.log(res.data.domain_ids)
        //             }
        ...
        //     // console.log(keywordsDataHolder.value)
        //     // console.log(campaign_domain_holder.value);
        //     // console.log(document.getElementById(
        //     //         "selected_articles_val"
        //     //     ).value)
        //     // random domains local key for storing the value | selectDomains
        //     // domain set local key for storing the value | selectSetDomains
