...
@section('main-content')
        ...
        <div class="w-full flex flex-wrap items-center">
            <div class="w-1/2 flex flex-col gap-2 flex-wrap">
                ...
                <div class="breadcrumb">
                    ...
                    <div class="breadcrumb-item">
                        <a href="{{ route('admin.hidden.link.campaign.index') }}" class="breadcrumb-link">PBN Sidebar</a>
                        <span>›</span>
                    </div>
                    <div class="breadcrumb-item">
    ...
    <form action="{{ route('admin.hidden.link.campaign.store') }}" method="POST"
        ...
        @csrf
        <h2 class="text-xl capitalize !mb-4 bg-[var(--primary-color)] text-white w-fit !p-2 rounded">Create Hidden Link
            Campaigns
        </h2>
