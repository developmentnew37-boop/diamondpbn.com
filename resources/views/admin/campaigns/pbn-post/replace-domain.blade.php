            ...
            <div>
                ...
                <div class="breadcrumb">
                    <div class="breadcrumb-item">
                        <a href="{{ route('admin.campaign.show', $campaign->id) }}" class="breadcrumb-link">
    ...
    <div class="content-card w-full !p-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 !mb-5">
            ...
            <div class="rounded border border-gray-200 !p-3">
                ...
                <div class="font-semibold">#{{ $post->id }} · {{ ucfirst($post->status) }}</div>
            </div>
            <div class="rounded border border-gray-200 !p-3">
        ...
        <form method="GET" action="{{ route('admin.campaign.domain-replacement.create', $post) }}"
        ...
        <form method="POST" action="{{ route('admin.campaign.domain-replacement.store', $post) }}">
            @csrf
            ...
            <input type="text" id="new_domain_name" name="new_domain_name"
                ...
                placeholder="Enter domain name, e.g. shopatstar.co.uk"
            ...
            <p class="text-sm text-gray-500 !mb-4">
                ...
                attached to this campaign. Any category is allowed. If publishing still fails after replacement,
                use Replace domain again with another domain — the system will not pick one for you.
            </p>
