...
@section('title', 'Create PBN Sidebar Campaign')
...
@section('main-content')
        ...
        <div class="w-full flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            <div class="w-full sm:w-1/2 flex flex-col gap-2 min-w-0">
                ...
                <div class="breadcrumb flex-wrap">
                    ...
                    <div class="breadcrumb-item">
                        <a href="{{ route('admin.sidebar.campaign.index') }}" class="breadcrumb-link">PBN Sidebar</a>
                        <span>›</span>
                    </div>
                    <div class="breadcrumb-item">
            ...
            <div class="w-full border-b border-[var(--primary-color)] flex items-center gap-2">
                <div class="flex flex-wrap items-center gap-2 w-full">
                    <label
                        ...
                        for="random-domains">
                        Random Domains (<span class="dy-domain-count" id="selectedSideBarDomainCount">0</span>)
                    ...
                    <label
                        ...
                        for="domain-sets">
                        Domain Sets (Domains - <span class="dy-domain-count" id="selectedSideBarSetDomainCount">0</span>)
                    ...
                    <table id="RandomDomainsTable" class="display w-full min-w-[700px] border border-gray-200 border-collapse text-sm ">
                        ...
                        <thead>
                            <tr class="bg-gray-800 text-white">
                                <th>
                                    <input type="checkbox" name="bulk_domain_select[]" id="selectAllSidebarDomains"
                                        class="scale-125 ">
                                </th>
                                @php
            ...
            <div class="w-full flex flex-wrap gap-3 items-start sm:items-center !mt-6">
                ...
                <div class="w-full flex flex-col max-h-[600px] overflow-x-auto overflow-y-auto !mt-6">
                    ...
                    <table id="domainSetTable" class="display w-full min-w-[700px] border border-gray-200 border-collapse text-sm ">
                        ...
                        <thead>
                            <tr class="bg-gray-800 text-white">
                                <th><input type="checkbox" name="bulk_set_domain_select[]"
                                        id="selectAllSidebarSetDomains" class="scale-125 "></th>
                                @php
                                    $tHead = ['sno', 'url', 'DA', 'TF', 'DR', 'SS'];
                                @endphp
                                @foreach ($tHead as $t)
    ...
    {{-- 
    <div class="content-card w-full flex flex-col gap-2 hidden opacity-0 duration-500 transition-all">
        <div class="w-full bg-[var(--sidebar-bg)] !p-4 flex justify-center rounded">
            <h2 class="text-white text-2xl">Sidebar Campaign Data</h2>
        </div>
        <div class="w-full flex flex-wrap justify-between !mt-4">
            <div class="w-[49%] flex flex-col gap-3">
                <h2 class="text-xl flex items-center gap-1 text-gray-400 w-fit bg-red-500 text-white !p-2 rounded">
                    <span class="material-symbols-outlined">
                        error
                    </span>
                    Error
                </h2>
                <div class="flex flex-wrap overflow-x-auto !mt-2 w-full">
                    <table class="w-full border border-gray-100 border-collapse text-sm " id="sidebar-error-data ">
                        <thead>
                            <tr class="bg-gray-200">

                                @php
                                    $tHead = ['Pbn', 'keyword', 'Url', 'Status'];
                                @endphp
                                @foreach ($tHead as $t)
                                    <th
                                        class="border border-gray-100  font-sans !font-normal !py-2 !px-1  capitilize text-sm capitalize">
                                        {{ $t }}
                                    </th>
                                @endforeach
                            </tr>
            ...
            <div class="w-[49%] flex flex-col gap-3">
                <h2 class="text-xl flex items-center gap-1 text-gray-400 w-fit bg-green-500 text-white !p-2 rounded">
                    <span class="material-symbols-outlined">
                        check_circle
                    </span>
                    Success
                ...
                <div class="flex flex-wrap overflow-x-auto !mt-2 w-full">
                    <table class="w-full border border-gray-100 border-collapse text-sm " id="sidebar-success-data ">
                        <thead>
                            <tr class="bg-gray-200">
    ...
    <div
        ...
        <div class="dy-key-pop-box w-[96%] sm:w-[90%] max-w-[min(96vw,1280px)] max-h-[calc(100vh-24px)] sm:max-h-none flex flex-col items-stretch !shadow-2xl bg-gray-50 border border-gray-300 z-2 rounded !mt-3 sm:!mt-[70px] opacity-0 -translate-y-[20%] linear duration-600 transition-all min-w-0"
            ...
            <div class="w-full flex flex-col gap-3 !p-3 max-h-[560px] overflow-auto">
                ...
                <div class="w-full flex flex-col gap-3 h-[400px] overflow-x-hidden overflow-y-auto bg-gray-100 keyword-tab-sec hidden !p-3"
...
<a href="https://example4.com" rel="noopener noreferrer">keyword 4</a>'></textarea>
    ...
    @push('scripts')
        ...
        <script type="module" src="{{ asset('js/create-sidebar-campaign.js') }}"></script>
