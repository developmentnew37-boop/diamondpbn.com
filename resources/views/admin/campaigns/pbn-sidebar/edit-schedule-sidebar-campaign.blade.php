    ...
    <div class="w-full flex flex-wrap justify-between items-start content-card !p-4 !mt-2">
        ...
        <div class="w-full flex flex-wrap gap-5 !p-2 !pb-0">
            ...
            @if ($showLocalClientTab)
                <button type="button" data-ss-edit-tab="local_client"
                    class="ss-edit-tab group flex flex-col gap-3 rounded !p-2 cursor-pointer text-lg w-fit {{ $editTab === 'local_client' ? 'text-[var(--primary-color)]' : 'duration-300 transition-all hover:text-[var(--primary-color)]' }}">
        ...
        @if ($showLocalClientTab)
            <div id="ss-edit-panel-local-client" data-ss-edit-panel="local_client"
                class="ss-edit-panel w-full !p-2 duration-500 transition-all {{ $editTab === 'local_client' ? '' : 'hidden opacity-0 translate-y-5' }}">
