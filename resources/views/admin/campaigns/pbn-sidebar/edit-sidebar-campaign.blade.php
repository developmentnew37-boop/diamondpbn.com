                    ...
                    <div class="w-full flex flex-wrap justify-between max-h-[420px] overflow-hidden overflow-y-auto bg-gray-100 rounded border border-gray-200 !p-3">
                        <div class="w-[49.5%] flex flex-col gap-2">
                            <div class="flex items-center">
                                ...
                                <span class="bulk-count text-sm flex !ml-[2px]" id="bulk-urls-edit-count"></span>
                            </div>
                            <textarea name="bulk_urls" id="bulk-urls-edit"
                                class="bg-gray-50 !p-2 text-sm outline-none border border-gray-300 w-full resize-none bulk-edit-input"
                        ...
                        <div class="w-[49.5%] flex flex-col gap-2">
                            <div class="flex items-center">
                                ...
                                <span class="bulk-count text-sm flex !ml-[2px]" id="bulk-keywords-edit-count"></span>
                            </div>
