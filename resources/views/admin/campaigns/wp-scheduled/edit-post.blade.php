...
@section('title', 'Edit WP Scheduled Post')
...
@section('main-content')
        ...
        <div class="w-full flex flex-wrap items-center">
            <div class="w-1/2 flex flex-col gap-2 flex-wrap">
                ...
                <div class="breadcrumb">
                    ...
                    <div class="breadcrumb-item">
                        <a href="javascript:void(0)" class="breadcrumb-link">Edit scheduled post</a>
                    </div>
                </div>
            </div>
            <div class="w-1/2 flex flex-wrap justify-end items-center"></div>
        </div>
    </div>
    ...
    <form action="{{ route('admin.wp.schedule.campaign.update.post', $campaignPost->id) }}" method="POST"
        ...
        <h2 class="text-xl capitalize !mb-4 bg-[var(--primary-color)] text-white w-fit !p-2 rounded">
            Edit {{ $fetchedData['post_title'] ?? 'Scheduled Post' }}
        </h2>
