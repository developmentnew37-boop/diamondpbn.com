...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-4 sm:p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col w-full max-w-full overflow-x-hidden">
    <header class="w-full max-w-full lg:max-w-4xl px-2 sm:px-0 text-sm mb-4 sm:mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
            <nav class="flex items-center justify-end gap-2 sm:gap-4 flex-wrap">
                @auth
    ...
    <div
        class="flex items-center justify-center w-full max-w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex w-full max-w-full sm:max-w-[335px] lg:max-w-4xl flex-col-reverse lg:flex-row">
            <div
                class="text-[13px] leading-[20px] flex-1 p-4 sm:p-6 pb-10 sm:pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none min-w-0">
            ...
            <div
                class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full max-w-full lg:w-[438px] shrink-0 overflow-hidden min-w-0">
                {{-- Laravel Logo --}}
                <svg class="w-full max-w-full text-[#F53003] dark:text-[#F61500] transition-all translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-6"
